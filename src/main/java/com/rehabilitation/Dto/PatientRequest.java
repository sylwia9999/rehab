...
public class PatientRequest {
    ...
    public PatientRequest(String firstName, String lastName, String email, String address, String phoneNumber, String pesel, Time timePreferencesFrom, Time timePreferencesTo, int locationPreferences) {
